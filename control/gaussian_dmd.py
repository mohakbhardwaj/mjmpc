#!/usr/bin/env python
"""
DMD-MPC with gaussian sampling policy, exponentiated
utility and covariance matrix adaptation.
...
class GaussianDMD(Controller):
    def __init__(self,
        ...
        super(GaussianDMD, self).__init__(num_actions,
                                   action_lows, 
                                   action_highs,  
                                   set_state_fn, 
                                   terminal_cost_fn,
